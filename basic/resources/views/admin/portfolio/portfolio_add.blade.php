                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="port_name" id="port_name">
                                                @error('port_name')
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="port_title" id="port_title" type="text" >
                                                @error('port_title')
                                                <span class="text-danger">{{$messege}}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="elm1" name="port_desc" ></textarea>
                                        ...
                                        <div class="row mb-3 ">
                                            ...
                                            <div class="col-sm-1">
                                                <img class="rounded avatar-lg" id="port_image" src="{{ url('upload/no_image.jpg') }}" alt="Card image cap">
                                        ...
                                        <input type="submit" value="Add Portfolio" class="btn btn-outline-info waves-effect waves-light">
                                        </form>
                                        <!-- end row -->
                                    </div>
                                </div>
