                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3 ">
                                            ...
                                            <div class="col-sm-1">
                                                <img class="rounded avatar-lg" id="multi_image" src="{{url('upload/no_image.jpg') }}" alt="Card image cap">
                                            </div>
                                            <div class="col-sm-9 mt-4">
                                                <input class="form-control" type="file" name="multi_image[]" id="image" multiple="" >
                                            </div>
                                        </div>
                                        <input type="submit" value="Add Multi Image" class="btn btn-outline-info waves-effect waves-light">
                                        </form>
                                        <!-- end row -->
                                    </div>
                                </div>
