...
@section('main')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8 col-md-10">
                            <div class="breadcrumb__wrap__content">
                                <h2 class="title">{{ $port->port_name }}</h2>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">{{ $port->port_name }}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
  ...
  <img src=" {{ asset($port->port_image) }} " alt="">
                            </div>
                            <div class="services__details__content">
                                <h2 class="title">{{ $port->port_title }}</h2>
                                <p> {!! $port->port_desc !!} </p>
