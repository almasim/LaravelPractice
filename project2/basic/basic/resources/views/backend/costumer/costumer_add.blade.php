...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('costumer.store') }}" enctype="multipart/form-data" >
                @csrf
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="mobile_number" class="form-control" type="text"   id="mobile_number">
                </div>
            </div>
            <!-- end row -->
