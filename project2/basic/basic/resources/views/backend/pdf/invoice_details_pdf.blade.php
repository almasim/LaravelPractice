                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Costumer Payment Report</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">Costumer Payment Report</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                <h4 class="float-end font-size-16"><strong>Invoice No # {{ $payment['invoice']['invoice_number'] }}</strong></h4>
                <h3>
    ...
    <table class="table">
      ...
      @php
        ...
        @endforeach
                            ...
                            <tr>
                                <td colspan="4" style="text-align:center;font-weight:bold;">{{date('Y m d',strtotime($item->date))}}</td>
