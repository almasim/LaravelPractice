                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Costumer Wise Credit Report</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">Costumer Wise Credit Report</li>
                                        </ol>
                                    </div>
    ...
    <table class="table">
      ...
      @php
        ...
        <tr>
            ...
            <td class="text-center">{{$item['costumer']['name']}}</td>
        ...
        @endforeach
                            <tr>
                                ...
                                <td class="no-line"></td>
                                <td class="no-line"></td>
                                <td class="no-line text-center"><h5><strong>Grand Due Amount</strong></h5></td>
